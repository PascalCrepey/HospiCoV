...
golem::fill_desc(
  pkg_name = "shinyCov", # The Name of the package containing the App 
  pkg_title = "HospiCov", # The Title of the package containing the App 
  pkg_description = "COVID-19 French national metapopulation model.", # The Description of the package containing the App 
  author_first_name = "Clement", # Your First Name
  author_last_name = "MASSONNAUD",  # Your Last Name
  author_email = "clement.massonnaud@gmail.com",      # Your Email
