...
caption = "Estimated date of ICU capacity overrun in the 13 metropolitan French Regions, for $R_0$ 1.5, 2.25, and 3. Simulations start on March 10, and end on April 14th, 2020. \\label{TABoverrunDate}"
...
caption = "Predicted number of infected cases, severe cases, and deaths, from March 10 to April 7, 2020, by Region, for $R_0$ values of 1.5, 2.25, and 3.\\label{TABcases}"
