...
We listed the 138 hospitals that are identified as referral centers for the treatment of COVID-19 cases [@REF]. Of those, 33 hospitals are listed as primary referral centers, and 98 as secondary referral centers [CA FAIT PAS 138!!]. We then divided metropolitan France into catchment areas around these referral hospitals using Voronoi polygons. Population structure was inferred for each catchment area from 2016 and 2017 census data provided by the French National Institute of Statistics and Economic Studies (Insee) [@REF]. We used the data on contact structure for the French population estimated by Prem and colleagues [@Prem2017], and applied it to the population structure of each catchment area.
