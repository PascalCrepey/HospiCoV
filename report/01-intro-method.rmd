...
data <- data.table(openxlsx::read.xlsx("../data-raw/EpiDataFrance.xlsx", 
                                      ...
                                      detectDates = TRUE))
data[!is.na(Metropole), France := Metropole]
...
```{r cases}
plotly::plot_ly(data, x= ~Date, y = ~France, type = "bar") %>%
    layout(title = "Number of confirmed COVID-19 cases in France from January 22 to March 14")
